...
namespace ISpan.Inseparable.Win
{
	public static class ComboUtilities
	{
		...
		/// <param name="cbo">物件</param>
		/// <returns></returns>
		public static ComboBoxItem GetItem(this ComboBox cbo)
		{
			ComboBoxItem item = new ComboBoxItem((int?)null, string.Empty);
		...
		//public static void BindTableToDDL(ComboBox cbo, DataTable dt, int? valueColumn, string textColumn, bool addEmpty)
		//{
		//	cbo.Items.Clear();
		//	if (addEmpty)
		//	{
		//		cbo.Items.Add(new ComboBoxItem((int?)null, string.Empty));
		//	}
