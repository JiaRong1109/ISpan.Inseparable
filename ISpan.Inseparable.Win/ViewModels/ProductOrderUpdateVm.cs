...
{
	public class ProductOrderUpdateVm
	{
	...
	public static class ProductOrderUpdateVmExtension
	{
		public static ProductOrderUpdateDto ToUpdateDto (this ProductOrderUpdateVm vm)
		{
			return new ProductOrderUpdateDto()
			{
